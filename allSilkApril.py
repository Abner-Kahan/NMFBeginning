...
def nmf2TesterMixB(ran1,ran2,broad,res):
    ...
    for n in range(11):
        IRF [n-1,:]= fetchIr('UntreatedSample.txt',n+1,ran1,ran2)
        
        IRF[n+10,:] =  fetchIr('MeOHSample.txt',n+1,ran1,ran2)
        IRF[n+21,:] =  fetchIr('WA45Sample.txt',n+1,ran1,ran2)
    for spec in IRF[:11,:]:
...
nmf2TesterMixB(amide1_ran1,amide1_ran2,3,1)  