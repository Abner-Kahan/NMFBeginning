...
# =============================================================================
    ...
    # for Type in TypeList:
    #     type_filter = filter(lambda x: ('bsheets' in x) and (Type in x), output)
    #     Inter =list(type_filter)
    #     Inter =sorted(Inter)
    #     specs = []
    #     legend = []
    ...
    #            #plt.vlines(peak+1450,0,info[peak])
    #        #print(peaks)
           
           
    #        #print("check" ,specs)
    #     IrPlotter(specs, "Bsheets " + Type[1:-1] + ' amide region', 1450, 1800, leg = legend, multiple = True, colors = 4)
